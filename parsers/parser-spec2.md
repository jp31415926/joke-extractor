...
## 2. Email Content Handling (Revised)
...
## 7. Example Skeleton (Updated)

```python
"""Parser for [Parser Name] — see parser-hints.md."""
...
def _can_be_parsed_here(email: EmailData) -> bool:
    return "parser@example.com" in email.from_header.lower()
